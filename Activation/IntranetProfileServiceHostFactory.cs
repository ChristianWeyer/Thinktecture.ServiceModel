...
{
    /// <summary>
    /// Custom ServiceHostFactory for creating ServiceHost instances that are tweaked for intranet hosting 
    /// scenarios.
    /// </summary>
    public sealed class IntranetProfileServiceHostFactory : System.ServiceModel.Activation.ServiceHostFactory
    {
        /// <summary>
        ...
        {
            return new ServiceHost(serviceType, Profile.Intranet, Flattening.Disabled, baseAddresses);
        }
    }
}